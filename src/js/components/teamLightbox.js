...
<div class="team-card">
    ...
    <a href="https://github.com/Andrew-del-maker" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">
      <use href="${spriteUrl}#github"></use>
    </svg></a>
</div>
<div class="team-card">
    ...
    <p class="team-role">Developer</p>
    <a href="https://github.com/Borys-Samoilenko" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">
      <use href="${spriteUrl}#github"></use>
    </svg></a>
</div>
<div class="team-card">
    ...
    <p class="team-name">Andrew</p>
    <p class="team-role">Developer</p>
    <a href="https://github.com/AndrewProsianyk" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">
      <use href="${spriteUrl}#github"></use>
    </svg></a>
</div>
<div class="team-card">
    ...
    <p class="team-role">Developer</p>
    <a href="https://github.com/R0st" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">
      <use href="${spriteUrl}#github"></use>
    </svg></a>
</div>
<div class="team-card">
    ...
    <p class="team-role">Developer</p>
    <a href="https://github.com/Bondarenkoalla" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">
      <use href="${spriteUrl}#github"></use>
    </svg></a>
</div>
<div class="team-card">
    ...
    <p class="team-role">Developer</p>
    <a href="https://github.com/GosuSosed" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">
      <use href="${spriteUrl}#github"></use>
    </svg></a>
</div>
<div class="team-card">
    ...
    <p class="team-role">Developer</p>
    <a href="https://github.com/Ievgen-Rybalko" target="_blank" class="team-git"><svg class="logo__icon" width="24" height="24">
      <use href="${spriteUrl}#github"></use>
    </svg></a>
</div>
<div class="team-card">
